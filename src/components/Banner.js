...
export const Banner = () => {
  ...
  const toRotate = [ "Fullstack Developer", "Desenvolvedor Front-end", "Desenvolvedor Back-end", "Devops Cloud" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                <span className="tagline">Bem vinda(o) ao meu portifólio!</span>
